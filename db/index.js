...
const UserSettings = require("../models/userSettingsModel")(sequelize, DataTypes);
...
module.exports = { sequelize, User, FriendRequest, Friendship, Message, Settings, UserSettings };
